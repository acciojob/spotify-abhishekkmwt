...
public class SpotifyController {
    ...
    public String createSong(@RequestParam("title") String title, @RequestParam("albumName")String albumName, @RequestParam("length") Integer length) throws Exception{
    ...
    public String createPlaylistOnLength(@RequestParam("mobile") String mobile, @RequestParam("title") String title, @RequestParam("length") Integer length) throws Exception{
